...
function cards() {
    class MenuCard{
        constructor(src, alt, titel, description, price, parentSelector, ...classes){
            this.src = src;
            this.alt = alt;
            this.titel = titel;
...
function showModalByScroll() {
    if (window.pageYOffset + this.document.documentElement.clientHeight >= this.document.documentElement.scrollHeight){
